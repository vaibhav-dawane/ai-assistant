...
const Features = () => {
    return (
        <div className='mx-auto flex justify-center mb-28'>
            <div className='grid grid-cols-3 gap-x-12 '>
                <div className='w-[380px] h-[250px] rounded-2xl border border-blue-200 grid grid-rows-2 grid-flow-row shadow-xl'>
